<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LogIn.aspx.cs" Inherits="UPHSD_OnlineVotingSystem.LogIn" %>
                            ...
                            <div class="col-lg-12">
                                <form>
                                    <div class="divLoginForm">
                                        ...
                                        <div class="form-group">
                                            <asp:TextBox ID="password" TextMode="Password" TabIndex="2" CssClass="form-control" placeholder="Password" runat="server"></asp:TextBox>
                                        </div>

                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-6 col-sm-offset-3">
                                                    <asp:Button ID="login_submit" name="login-submit" class="form-control btn btn-login" runat="server" TabIndex="4" Text="Log In" OnClick="login_submit_Click" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
